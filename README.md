...
TCNOpen TRDP 3.0.0.0 is vendored as MPL-2.0 source and built into a separate TauTerm sidecar. Windows live capture uses a separately installed Npcap; Linux/macOS use the system libpcap. Offline capture analysis does not require either capture runtime. TRDP Workspace v2 imports validated object/XML/redundancy configuration without automatically starting network transmission.
