...
Defines lrzsz-compatible cancellation handling for YMODEM transfers, including two-consecutive-CAN detection and the standard cancel transmission sequence (10 CAN + 8 BS).
