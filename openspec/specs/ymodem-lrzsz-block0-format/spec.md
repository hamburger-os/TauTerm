# ymodem-lrzsz-block0-format

## Purpose

Defines lrzsz-compatible Block 0 metadata format for YMODEM file transfers, including filename encoding, size/mtime/mode serialization, sector-count trailer, and batch-end signaling.
