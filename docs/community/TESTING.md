...
- terminal clipboard contracts verify configurable copy/paste shortcuts, compatibility aliases, capture-phase paste routing, xterm `paste()` ownership, Bracketed Paste Mode awareness and the multi-line confirmation threshold;
