...
- **File-manager completion speed visibility** — successful SFTP cards retain the last reliable backend I/O throughput sample through Finalizing/Completed and display it during the existing five-second auto-dismiss window; normal narrow sidebars keep live speed visible, with speed hidden only at the <=220px emergency layout.
